      ...
      content: (
        <Container>
          <ProjectHeader
            ...
            responsibilities="User Research, Strategy, UX Design, Service Design"
            roleSummary="My team was responsible for adding access management functionality to the existing Activate platform. The team comprised of 1 product manager, 10 engineers, 2 QAs, 1 designer (me!)."
            pictureFile="wclogo.png"
            // alt="Reserve in Store overlay"
            // caption="Reserve in Store overlay."
          />
